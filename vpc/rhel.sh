...
declare -A driver_versions=(
    ...
    ["4.18.0-553.16.1.el8_10.x86_64"]=560   # ibm-redhat-8-10-minimal-amd64-2
    ...
    ["5.14.0-427.33.1.el9_4.x86_64"]=560    # ibm-redhat-9-4-minimal-amd64-4
)
...
if [[ -n $cuda_version ]] && [[ $cuda_version != "n" ]]; then
...
if [[ $cuda_version == "y" ]]; then
    ...
    dnf -y install "cuda-toolkit-${supported_version/./-}"
